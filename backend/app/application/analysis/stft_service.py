...
Responsibilities:
  ...
  5. Delegate pure computation to the STFTEngine (domain layer).
...
class STFTService:
    ...
    async def get_stft(
        ...
        result = compute_stft(segment, sampling_rate_hz, config)
    ...
    async def get_spectrogram(
        ...
        result = compute_spectrogram(amplitudes, sampling_rate_hz, config)
